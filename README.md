...
# Optional display name for invite emails
INVITE_FROM_NAME=TalentTool
# Optional explicit invite-link host (recommended in multi-env Vercel setups)
INVITE_BASE_URL=https://app.talenttool.nl
